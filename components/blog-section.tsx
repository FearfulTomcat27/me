...
export function BlogSection({ data = blogData }: BlogSectionProps) {
  return (
    <div className='space-y-6 md:space-y-8'>
      <div>
        <h2 className='text-2xl md:text-3xl font-bold text-foreground mb-4'>博客(完善中)</h2>
          ...
          >
            ...
            <div className='p-4 md:p-5'>
              <div className='flex items-center gap-2 flex-wrap text-xs text-muted-foreground mb-3'>
                <span className='px-2.5 md:px-3 py-0.5 md:py-1 bg-accent/10 text-accent rounded-full font-medium'>{post.category}</span>
